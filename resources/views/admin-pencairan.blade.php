    ...
    <div class="wrapper">
        <div class="box pd-5">
            <form action="" method="post" class="center wp-50">
                ...
                <p class="montserrat fw-600 fs-30">ID produk: <span>{{ $pencairan->pemesanan->produk->id }}</span></p>
                <p class="montserrat fw-600 fs-30">Nama produk: <span>{{ $pencairan->pemesanan->produk->nama_produk }}</span></p>
